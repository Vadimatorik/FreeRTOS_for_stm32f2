...
FREE_RTOS_H_FILE			:= module_freertos_for_stm32f2/FreeRTOS.h
FREE_RTOS_H_FILE			+= $(wildcard module_freertos_for_stm32f2/include/*.h)

# Директории, в которых лежат файлы FreeRTOS.
FREE_RTOS_DIR				:= module_freertos_for_stm32f2
FREE_RTOS_DIR				+= module_freertos_for_stm32f2/include
...
FREE_RTOS_C_FILE			:= $(wildcard module_freertos_for_stm32f2/*.c)
